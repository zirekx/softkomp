<template>
    <div class="parent">
  <div class="child"></div>
  <div class="child child--absolute">
...
<div class="container">
  <div class="frame">
    <div class="nav">
      <ul class="links">
        <li class="signin-active"><a class="btn">Strony WWW</a></li>
        <li class="signup-inactive"><a class="btn">Programy WAPRO</a></li>
		<li class="signup-inactive"><a class="btn">Programy SOFT-KOMP</a></li>
      </ul>
    </div>
    <div>
          ...
          <label for="password">Nazwusko</label>
          <input class="form-styling" type="text" name="password" placeholder=""/>
          <input type="checkbox" id="checkbox"/>
          <label for="checkbox" ><span class="ui"></span>Zgadzam się na ptrzetwarzanie danych osobowych.</label>
...
.child--absolute {
  ...
  align-items:flex-end;
	...
	top: 0;
	left: 0;
	clip-path: polygon(100% -252%, 20% 100%, 100% 100%);
	background: #0e1111;
	z-index: 1;
	font-size:14px;
}
